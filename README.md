學號：11428229  姓名：曾立薰
模擬頁面網址：https://github.com/lceng2780-crypto/xun1129
# 排序法綜合報告
...
本次比較顯示，氣泡、選擇、插入排序法雖然原理簡單、易於理解，適合教學與小型資料，但在大數據下效率極低。合併排序與快速排序法則能有效處理大量資料，尤其快速排序平均效率最佳，但最壞情況下可能退化。合併排序則在穩定性與效率間取得平衡，但需額外空間。選擇排序與快速排序皆為不穩定排序，若資料穩定性有要求需注意。實務上，排序法的選擇應根據資料規模、特性與應用需求做出判斷。